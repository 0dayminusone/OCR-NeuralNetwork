...
class SearchFilter {
  ...
  @override
  String toString() {
    return 'SearchFilter(context: $context, filename: $filename, description: $description, language: $language, ocrText: $ocrText, people: $people, location: $location, camera: $camera, date: $date, display: $display, mediaType: $mediaType)';
  }
